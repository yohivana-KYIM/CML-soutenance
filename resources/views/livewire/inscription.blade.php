<main class="mt-0 transition-all duration-200 ease-soft-in-out">
                    ...
                    <div
                        ...
                        <div class="flex-auto p-6">
                            ...
                            <form wire:submit.prevent="store">
                                ...
                                <div class="mb-4">
                                    <input wire:model.lazy="fonction" type="text"
                                        class="text-size-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                        placeholder="Fonction" name="fonction" aria-label="Name" aria-describedby="email-addon"
                                        required autofocus />
                                    @error('fonction')
                                    <p class="text-size-sm text-red-500">{{ $message }}</p>
                                    @enderror
 ...
 <div class="mb-4">
                                    <input wire:model.lazy="email" type="email"
                                        class="text-size-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                        placeholder="email" name="fonction" aria-label="email" aria-describedby="email-addon"
                                        required autofocus />
                                    @error('email')
                                    <p class="text-size-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                ...
                                <div >
                                    ...
                                    <select name="role_id" wire:model.lazy="role_id" type="text"class="form-select form-select-sm
                                    appearance-none
                                    block
                                    w-full
                                    px-2
