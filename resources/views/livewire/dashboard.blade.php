...
<h2><strong>BIENVENUE DANS LE  SYSTEM DU CML(Centre Medical La Life)</strong></h2>
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans font-semibold leading-normal text-size-sm">New personnels</p>
                ...
                <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans font-semibold leading-normal text-size-sm">pointages</p>
                                    <h5 class="mb-0 font-bold">
1
                                        <span
                                            class="leading-normal text-size-sm font-weight-bolder text-lime-500">+</span>
                                    </h5>
                                </div>
                            </div>
                            <div class="px-3 text-right basis-1/3">
                ...
                <div
                    ...
                    <div class="relative h-full overflow-hidden bg-cover rounded-xl"
                        ...
                        <div class="relative z-10 flex flex-col flex-auto h-full p-4">
                            <h5 class="pt-2 mb-6 font-bold text-white">SYSTEM MEDICAL POINTAGES</h5>
                            <p class="text-white">developper par iVANA  .</p>
