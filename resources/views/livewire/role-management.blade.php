...
<div class="flex flex-wrap -mx-3">
    ...
    <div class="flex-none w-full max-w-full px-3">
        ...
        <p class="mb-0 font-semibold leading-tight text-base">
            <a href="{{route('editrole',$role->id)}}"onclick="confirm('Are you sure you want to updated the role') || event.stopImmediatePropagation()"><i class="fas fa-user-edit" aria-hidden="true"></i></a>


         <a href="#"onclick="confirm('Are you sure you want to remove the role') || event.stopImmediatePropagation()" wire:click.prevent="delete({{$role->id}})"><i class="cursor-pointer fas fa-trash" aria-hidden="true"></i></a>
                                    </p>
                                </td>
                            </tr>
@endif
