                    ...
                    <div class="w-full px-6 py-4 bg-white rounded shadow-md ring-1 ring-gray-900/10">
                        ...
                        <form action="{{ route('emplois.update',$emploi->id) }}" method="POST">
                            ...
                            <div class="mt-4">>
                                ...
                                <input type="text" name="nom_emploi" value="{{$emploi ->nom_emploi }}" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="nom_emploi">
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-gray-700" for="date_debut">date_debut</label>
                                <input type="date" name="date_debut"value="{{$emploi->date_debut }}" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="date_debut">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                m-0
                                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" aria-label=".form-select-sm example">
                                    <option selected>+Selectionner un libelle pour legende</option>
