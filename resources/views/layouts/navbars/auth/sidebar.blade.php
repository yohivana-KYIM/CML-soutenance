...
<aside
  ...
  <li class="mt-0.5 w-full">
            <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              ...
              <span
                class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Equipe
              </span>
            </a>
          </li>
        ...
        <li class="mt-0.5 w-full">
            <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
              ...
              <span
                class="{{ (Request::is('rtl') ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">role-management</span>
            </a>
          </li>
